module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Rony",
  description: "Search on pinterest",
  usages: "${prefix}pinterest [image/number]",
  group: "Pinterest",
  cooldowns: 5,
  dependencies: {
    "axios": ""
...
module.exports.run = async function({ api, event, args }) {
    ...
    const res = await axios.get(`https://redapi-kpdc.onrender.com/pinterest?search=${encodeURIComponent(keySearchs)}`);
